    ...
    <section className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-semibold tracking-tight text-zinc-900">All Books</h1>
        ...
        {items.length === 0 ? (
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 text-center space-y-4">
            <p className="text-sm text-zinc-600">No books in your library yet.</p>
            <button
          ...
          <div className="rounded-2xl border border-zinc-200 bg-white p-8 text-center space-y-4">
            <p className="text-sm text-zinc-600">No books match your filters.</p>
            <button
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {filteredItems.map((item, idx) => (
              <LibraryTile key={item.id} item={item} index={idx} kind="book" />
            ))}
          </div>
        )}
      </div>
